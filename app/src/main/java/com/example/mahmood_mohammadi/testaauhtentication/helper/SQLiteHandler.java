...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    private static final String KEY_USER_CREATED_DATE = "crreateDate";
    ...
    private static final String KEY_WALLET_PASSPAYMENT = "passPayment";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_LOGIN_TABLE_WALLET = "CREATE TABLE " + TABLE_WALLET + "("
                ...
                + KEY_WALLET_PASSPAYMENT + "TEXT ," + Key_WALLET_IS_DEFAULT + "boolean DEFAULT 0,"
                + KEY_WALLET_IS_SELECTED + "boolean DEFAULT 0 , " + KEY_WALLET_ADDRESS + " TEXT, "
                + KEY_WALLET_BANNER + "TEXT ," + KEY_WALLET_LOGO + "TEXT" + KEY_WALLET_WALLET_TYPE + "INTEGER DEFAULT 1" + ")";
    ...
    public Boolean addWallet(Wallet wallet ,Long userId) {
        ...
        w_values.put(KEY_WALLET_PASSPAYMENT, wallet.getPassPayment()); //pass Payment
        w_values.put(KEY_WALLET_WALLET_TYPE, wallet.getTypeId()); //type Id
        ...
        w_values.put(Key_WALLET_IS_DEFAULT, wallet.getIsdefault());
