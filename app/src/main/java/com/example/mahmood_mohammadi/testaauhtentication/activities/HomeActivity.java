...
import com.example.mahmood_mohammadi.testaauhtentication.fragment.AddMoneyFragment;
import com.example.mahmood_mohammadi.testaauhtentication.fragment.ContactFragment;
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener onNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.navigation_wallet_management:
                    ...
                    frag_wallet_Transaction.replace(R.id.content, walletManagementFragment, "walletManagement");
