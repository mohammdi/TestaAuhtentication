...
public class CustomPersianCalendar {
    ...
    public static Calendar getGregorianCalendar(CustomPersianCalendar jalali){
     ...
     * Constructor
     * */
    public CustomPersianCalendar(Calendar gregorian) {
     ...
     * */
    public CustomPersianCalendar(String jalaliString){
    ...
    public CustomPersianCalendar(CustomPersianCalendar jalali){
        setPersainCalendarWithJalali(jalali.getYear(), jalali.getMonth(), jalali.getDay(),
                jalali.getHour(), jalali.getMinute(), jalali.getSecond());
    }

    public CustomPersianCalendar(int jalaliyear, int jalalimonth, int jalaliday){
        setPersainCalendarWithJalali(jalaliyear, jalalimonth, jalaliday);
    }

    public CustomPersianCalendar(int jalaliyear, int jalalimonth, int jalaliday, int jalalihour,
    ...
    public boolean isEqual(CustomPersianCalendar jalali){
    ...
    public int compareTo(CustomPersianCalendar jalali){
